...
function Update() {
        ...
        const fetchData = async () => {
            try {
                ...
                if (medtype === 'tablet') {
                    ...
                    setExp(format(new Date(response.data.expdate),'yyyy-MM-dd'))
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response= await axios.put(`http://localhost:3000/crud/update/${id}`, {
                medtype: medtype,
                batch: batch,
                medName: medName,
                ...
                setAlert1("Updated Successfully");
            ...
            // navigate('/edit/${id}'); // Redirect to the home page after successful update
        } catch (error) {
            console.error(error);
            setAlert2(error);
            setTimeout(() => {
