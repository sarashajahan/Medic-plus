...
const Table = ({ patients }) => {
    ...
    const handlePatientDetails = async (opno) => {
        navigate(`/patient/${opno}`);
      };
                ...
                <tbody>
                    {patients.map((patient) => (
                        <tr key={patient.opno}>
                            ...
                            <td>
                            <button  className="quick-button-2" style={{ marginRight: "25%", marginTop: "25%" }} onClick={() => handlePatientDetails(patient.opno)}>Details</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
